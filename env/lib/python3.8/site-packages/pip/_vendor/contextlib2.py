...
class ExitStack(object):
    ...
    def _push_cm_exit(self, cm, cm_exit):
        """Helper to correctly register callbacks to __exit__ src"""
    ...
    def push(self, exit):
        ...
        Can suppress exceptions the same way __exit__ src can.

        Also accepts any object with an __exit__ method (registering a call
        to the method instead of the object itself)
        """
        # We use an unbound method rather than a bound method to follow
        # the standard lookup behaviour for special src
    ...
    def enter_context(self, cm):
        ...
        """
        # We look up the special src on the type to match the with statement
